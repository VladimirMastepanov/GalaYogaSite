...
const CarouselEvent = () => {
  ...
  return (
    <section className='row justify-content-center mx-auto-section' >
      <div id='carousel' className='carousel slide  my-3 p-0' >
        ...
        <div className='carousel-inner'>
          <div className={cn('carousel-item', { 'active': active === 0 })}>
            <img src='../public/pic/d1.jpg' className='d-block w-100' alt='холодец' />
          </div>
          <div className={cn('carousel-item', { 'active': active === 1 })}>
            <img src='../public/pic/d2.jpg' className='d-block w-100' alt='...' />
          </div>
          <div className={cn('carousel-item', { 'active': active === 2 })}>
            <img src='../public/pic/d3.jpg' className='d-block w-100' alt='...' />
          </div>
        </div>
