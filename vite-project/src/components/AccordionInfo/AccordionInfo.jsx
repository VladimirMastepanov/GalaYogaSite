...
const AccordionInfo = () => {
  ...
  return (
    <section className='accordion-section'>
      <div className="accordion rounded-2 shadow-sm">
        <div className="accordion-item  border border-dark border-opacity-10">
        ...
        <div className="accordion-item  border border-dark border-opacity-10">
          <h2 className="accordion-header">
            <button onClick={handleToggleSecond} className="accordion-button collapsed " type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseOne" aria-expanded={showSecond} aria-controls="panelsStayOpen-collapseOne">
